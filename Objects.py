...
class State:
	...
	def __repr__(self):
		return "{name:" + self.name + ", abbreviation:" + self.abbreviation + ", ev:" + str(self.ev) + ", population:" + str(self.population) + ", election:" + str(self.election16) + ", pvi:" + str(self.pvi) + ", demographics:" + str(self.dem) + ", registration:" + str(self.registration) + ", turnout:" + str(self.turnout) + ", polls:" + self.polls + "}"
